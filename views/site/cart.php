...
<section class="cart__order-result">
    <div class="order-result__wrapper">
        ...
        <dl class="order-result__row">
            <dd class="order-result__item">Товаров:</dd>
            <dt class="order-result__item-value">3 товара</dt>
        </dl>
        <dl class="order-result__row order-result__row--total">
            <dd class="order-result__item">Общая сумма</dd>
            <dt class="order-result__item-value">1710 &#8381;</dt>
        </dl>
    </div>
</section>
<section class="cart__user-info">
    ...
    <form action="" method="">
        <fieldset>
            <legend class="user-info__input-title">Персональные данные</legend>
            <div class="user-info__input-wrapper">
                ...
                <div class="user-info__help-wrapper">
                    <input class="user-info__input" name="surname" type="text"  placeholder="Фамилия*">
                    <div class="help-block"></div>
                </div>
            </div>
            <div class="user-info__input-wrapper">
        ...
        <fieldset>
            <legend class="user-info__input-title">Способ доставки</legend>
        ...
        <fieldset>
            <legend class="user-info__input-title">Укажите дату и время доставки</legend>
            <div class="user-info__input-wrapper">
                <div class="user-info__help-wrapper">
